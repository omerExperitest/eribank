...
public class PaymentHomeActivity extends Activity {
	...
	private Button makePaymentButton, morgageRequestButton, expenseReportButton, logoutButton, advancedActios;
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		advancedActios = (Button) findViewById(R.id.AdvancedActionsButton);
		...
		advancedActios.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				try {
					startActivity(new Intent(PaymentHomeActivity.this, AdvancedActions.class));
				} catch (Exception ex) {
					Log.e(this.getClass().getName(), "Error : " + ex.getMessage(), ex);
				}
			}
